...
input ="AllyearsAllLingos.csv"
data = ps.read_csv(input,delimiter=(";"))
haskelX = data.drop(columns=['haskell_score','succesH','succesP','prolog_score','student_id'])
haskelY = data['succesH']

prologX = data.drop(columns=['haskell_score','succesH','succesP','prolog_score','student_id'])
