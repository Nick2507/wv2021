...
inputFile = "Prolog_Last3Years.csv"

data = ps.read_csv(inputFile,delimiter=(","))

X = data.drop(columns=['student_id','TotalScore','BinaryScore'])
y = data['BinaryScore']
print(f"Prolog laatste 3 jaar file is {inputFile}")
print()

vlifOK = ['av_MockSubs', 'nb_CompleteImportance3Subs', 'av_CompleteImportance3DiffRatio',
'avdiffDeadline.1', 'nmbrCheatOnTime.1', 'nmbDaySubsOnTImeCompleted.1', 'nbMorningCompleteSubs',
'nbNightCompleteSubs', 'nmbrOctoberSubs', 'avNmbrShort_05', 'avNmbrAroundSol_0.25']
Xvlif = data[vlifOK]
