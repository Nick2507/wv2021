...
inputFile = "variabelen_zonder_null_haskell_2021.csv"

data = ps.read_csv(inputFile, delimiter=(";"))

X = data.drop(columns=['haskell_score','succes','student_id','haskellscore','R1','R2','R'])
k = ['haskell_score','succes','student_id','haskellscore','R1','R2','R']
original = k.copy()
